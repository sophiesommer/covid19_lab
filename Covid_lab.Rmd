...
We can get a different, finer grain look at some of these relationships by looking at scatter plots. To start, we plot a scatter plot of the proportion of the population that is white and the positive case rate.  
```{r}
