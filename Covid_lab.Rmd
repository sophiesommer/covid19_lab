...
\newline  
\newline  
Another thing to take a look at: you may have noticed that we split case rate and proportion white into only two equally sized categories above. Here is the code again. See if you can change the code to split the zip codes into 3, or even 4 categories. Do you notice a different pattern?  
